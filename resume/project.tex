...
%---------------------------------------------------------
  \cventry%
    ...
    {\href{https://github.com/zivdar001matin/drl-drone-movement}{\underline{Github}}} % Prof.
    {Winter 2021} % Date(s)
  ...
  \cventry%
    ...
    {\href{https://github.com/zivdar001matin/computational-intelligence-final-project}{\underline{Github}}} % Prof.
    {Fall 2021} % Date(s)
  ...
  \cventry%
    ...
    {\href{https://github.com/zivdar001matin/web-crawler-detection}{\underline{Github}}} % Prof.
    {Summer 2021} % Date(s)
